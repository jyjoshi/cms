...
public final class FragmentOrderBinding implements ViewBinding {
  ...
  private FragmentOrderBinding(@NonNull RelativeLayout rootView, @NonNull RecyclerView menuList) {
  ...
  public static FragmentOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOrderBinding((RelativeLayout) rootView, menuList);
    }
