...
public final class ActivityTestBinding implements ViewBinding {
  ...
  private ActivityTestBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView3,
      @NonNull TextView orderPlacedText, @NonNull TextView textView4) {
    this.rootView = rootView;
    this.imageView3 = imageView3;
    this.orderPlacedText = orderPlacedText;
  ...
  public static ActivityTestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTestBinding((ConstraintLayout) rootView, imageView3, orderPlacedText,
          textView4);
    }
