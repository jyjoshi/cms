...
public final class ActivityAdminViewOrderBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAdminViewOrderBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityAdminViewOrderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdminViewOrderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_admin_view_order, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdminViewOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminViewOrderBinding((LinearLayout) rootView, headerBillAmount,
