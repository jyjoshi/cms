...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton cartButton, @NonNull Toolbar toolbar) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cart_button;
      FloatingActionButton cartButton = rootView.findViewById(id);
      if (cartButton == null) {
        break missingId;
      }
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, cartButton, toolbar);
    }
