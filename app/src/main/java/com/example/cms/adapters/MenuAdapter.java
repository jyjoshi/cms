...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuViewHolder> {
    ...
    Context context;
    String phoneNumber;
    DatabaseReference root = FirebaseDatabase.getInstance("https://canteen-management-systems-19bce.asia-southeast1.firebasedatabase.app/").getReference().child("temp");
