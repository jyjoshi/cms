...
import com.example.cms.activities.EditFoodActivity;
import com.example.cms.models.MenuItem;
import com.example.cms.R;

import java.util.ArrayList;

public class ExistingMenuEditorAdapter extends RecyclerView.Adapter<ExistingMenuEditorAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public ExistingMenuEditorAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
