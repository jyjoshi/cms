...
import static com.example.cms.activities.NotificationClass.NOTIFICATION_ID;
...
//    private static final String NOTIFICATION_ID = "Notification_id";
    ...
    public void onNewToken(@NonNull String s) {
        ...
        if(mAuth.getCurrentUser() != null) {
            ...
            FirebaseDatabase.getInstance("https://canteen-management-systems-19bce.asia-southeast1.firebasedatabase.app/").getReference().child("MessageIds").child(phoneNo).setValue(s);
        }
