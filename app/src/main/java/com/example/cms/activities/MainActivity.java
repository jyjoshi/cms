...
//
    ...
    private void initData() {
        DatabaseReference root = FirebaseDatabase.getInstance("https://canteen-management-systems-20a8c.asia-southeast1.firebasedatabase.app/").getReference("Bill");
        int time = 100;
        int price = 150;
        int tId = 1001;
        ...
        for(int i = 0; i < 10; i++){
            ...
            FirebaseDatabase.getInstance("https://canteen-management-systems-20a8c.asia-southeast1.firebasedatabase.app/").getReference().child("Status").child(sTId).setValue(Integer.toString(0));
